...
六场景浏览器工作的独立 DRY_RUN 计划已完成：`artifacts/verification/g8/g8-browser-scenario-plan-20260814-001/browser-scenario-plan.json`，`plan_id=4d99e1f6-2a20-5d0d-b979-dd1c8effa301`，`plan_hash=30e9a2d6f2a02a08d3bcc60f56914b23b8e26b905091ff2daaaa2bfd0fe53ab4`，绑定提交 `4da20e58efd45a58cbc3628ef7a6b10091d9eaca`。计划冻结 `demo_cold/demo_clear/demo_topic/demo_path/demo_negative/demo_degraded` 六个场景的 UUID、输入、期望状态、DOM 断言和 `deepseek-v4-flash` 调用上限；预计数据库最多追加 306 行、外部模型最多 80 次，Outbox、删除、Neo4j/Chroma 写入均为 0。计划已通过 `verify-g8-browser-scenario-plan`，但未获该精确 plan_id/hash 的独立执行批准前不会发送六场景业务 POST。
