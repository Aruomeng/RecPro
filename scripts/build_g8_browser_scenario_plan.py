...
def build_plan(*, run_id: str, baseline_path: Path, compose_project: str, mysql_database: str = "recpro", frontend_origin: str = "http://127.0.0.1:5173/", backend_origin: str = "http://127.0.0.1:8000/") -> dict[str, Any]:
    ...
    scenarios = [
        ...
        _scenario(run_id, "reading_path_clarification", "demo_path", _request(run_id, "path", "请给我一条从推荐系统基础到多智能体智慧图书馆的学习路径", ["BOOK", "PAPER"], "READING_PATH", 8), "DEGRADED_COMPLETED", "READING_PATH", "DEGRADED", 0, ["DEGRADED", "缺口"], ["readiness_get", "recommendation_post", "recommendation_replay"], 56, 16, 6),
