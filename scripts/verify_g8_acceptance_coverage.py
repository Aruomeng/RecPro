...
CASE_COVERAGE: Mapping[str, dict[str, Any]] = {
    ...
    "A07": {
        "offline_assessment": "MISSING",
        "assessment_reason": "ALREADY_READ projection code exists, but no test proves that only the target resource is suppressed while topic interest is retained.",
        "test_refs": [],
    ...
    "A12": {
        "offline_assessment": "MISSING",
        "assessment_reason": "Neo4j read-only parameterization is covered, but no timeout-injection test proves kg_score=null and non-invented explanations.",
        "test_refs": [],
    ...
    "A17": {
        "offline_assessment": "MISSING",
        "assessment_reason": "No direct test currently asserts author/topic caps or the diversity_relaxed trace when candidates are insufficient.",
        "test_refs": [],
    ...
    "A24": {
        "offline_assessment": "MISSING",
        "assessment_reason": "Intent classification exists, but no two-round near-threshold stability test with explicit-intent override is present.",
        "test_refs": [],
        "source_refs": ["backend/app/recommendation/application/intent.py", "backend/app/recommendation/agents/llm_agents.py"],
        "tool_refs": [],
        "artifact_globs": ["artifacts/verification/g4/g4-orchestrator-*/orchestrator.json"],
